...
namespace ET
{
    public static class BuildAssembliesHelper
    {
        ...
        public static void BuildModel(CodeOptimization codeOptimization, GlobalConfig globalConfig, string rootWolongHotUpdateDllDir = null)
        {
            List<string> codes;
            ...
            if(string.IsNullOrEmpty(rootWolongHotUpdateDllDir) )
            {
            ...
            {
                File.Copy(Path.Combine(Define.BuildOutputDir, $"Model.dll"), Path.Combine(rootWolongHotUpdateDllDir, $"Model.dll"), true);
                File.Copy(Path.Combine(Define.BuildOutputDir, $"Model.pdb"), Path.Combine(rootWolongHotUpdateDllDir, $"Model.pdb"), true);
            }

            Debug.Log("copy Model.dll to Bundles/Code success!");
        }

        public static void BuildHotfix(CodeOptimization codeOptimization, GlobalConfig globalConfig, string rootWolongHotUpdateDllDir = null)
        {
            ...
            {
                File.Copy(Path.Combine(Define.BuildOutputDir, $"{logicFile}.dll"), Path.Combine(rootWolongHotUpdateDllDir, $"Hotfix.dll"), true);
                File.Copy(Path.Combine(Define.BuildOutputDir, $"{logicFile}.pdb"), Path.Combine(rootWolongHotUpdateDllDir, $"Hotfix.pdb"), true);
            }
